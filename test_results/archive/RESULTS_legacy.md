...
> 이 문서는 2026-06-04에 수행한 초기 기능·sanity test 기록이다. 소수의 선택된
> 샘플 결과이므로 일반화 성능을 의미하지 않는다. 최신 공식 평가는 저장소 루트의
> `TEST_RESULTS.md`와 `test_results/training/run_20260620_leakage_fixed.json`을 참조한다.
